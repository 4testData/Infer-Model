...
from bayesUnet3D import BayesUNet3DKG
# import imutils
...
def create_model(model_name, num_classes, depth, dropout=0.50, batch_norm=True, type='tflite'):
...
def perform_inference(input_list = None, model = None, model_name = None, n_mc_samples = None, is_training=True, type='tflite'):
    if type == 'normal':
        ...
        print("Model Invoke check before!!")
        model.invoke()
        print("Model Invoke check After!!")
